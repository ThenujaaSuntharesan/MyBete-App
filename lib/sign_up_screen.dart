...
//           break;
//         default:
//           errorMessage = 'An unexpected error occurred. Please try again. Error: ${e.code} - ${e.message}';
//       }
//       ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(errorMessage)));
//     } catch (e) {
//       ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('An unexpected error occurred. Please try again. Error: $e')));
//     }
//   }
//
//   @override
