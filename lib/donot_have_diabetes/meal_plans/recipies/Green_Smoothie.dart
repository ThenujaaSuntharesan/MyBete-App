...
class B5RecipeDetailScreen extends StatefulWidget {
  const B5RecipeDetailScreen({Key? key}) : super(key: key);

  @override
  _B5RecipeDetailScreenState createState() => _B5RecipeDetailScreenState();
}

class _B5RecipeDetailScreenState extends State<B5RecipeDetailScreen> {
    ...
    return Scaffold(
      body: Stack(
        children: [
          // Background Image
          Image.asset(
            'lib/donot_have_diabetes/meal_plans/meal_images/Spinach Smoothie.jpeg',
