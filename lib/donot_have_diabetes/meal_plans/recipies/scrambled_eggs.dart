...
class B2RecipeDetailScreen extends StatefulWidget {
  const B2RecipeDetailScreen({Key? key}) : super(key: key);

  @override
  _B2RecipeDetailScreenState createState() => _B2RecipeDetailScreenState();
}

class _B2RecipeDetailScreenState extends State<B2RecipeDetailScreen> {
