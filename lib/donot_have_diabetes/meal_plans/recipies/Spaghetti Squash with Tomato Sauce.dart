...
class L10RecipeDetailScreen extends StatefulWidget {
  const L10RecipeDetailScreen({Key? key}) : super(key: key);

  @override
  _L10RecipeDetailScreenState createState() => _L10RecipeDetailScreenState();
}

class _L10RecipeDetailScreenState extends State<L10RecipeDetailScreen> {
  ...
  // Recipe data
  final String recipeName = 'Spaghetti Squash with Tomato Sauce';
    ...
    try {
      ...
      Map<String, dynamic> recipeData = {
        ...
        'instructions': [
          ...
          'Cut spaghetti squash in half and bake for 35-40 minutes.',
          'Once cooked, scrape the inside with a fork to create "spaghetti" strands.',
          'Heat olive oil in a pan, sauté garlic and mushrooms for 3 minutes.',
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildBulletPoint('½ spaghetti squash'),
                                _buildBulletPoint('1 cup tomato sauce'),
                                _buildBulletPoint('½ cup mushrooms (sliced)'),
                                _buildBulletPoint('½ tsp garlic (minced)'),
                                _buildBulletPoint('1 tbsp olive oil'),
                                _buildBulletPoint('1 tbsp parmesan cheese (optional)'),
                                ...
                                const SizedBox(height: 8),
                                _buildNumberedStep(2, 'Cut spaghetti squash in half and bake for 35-40 minutes.'),
                                const SizedBox(height: 8),
                                _buildNumberedStep(3, 'Once cooked, scrape the inside with a fork to create "spaghetti" strands.'),
                                const SizedBox(height: 8),
                                _buildNumberedStep(4, 'Heat olive oil in a pan, sauté garlic and mushrooms for 3 minutes.'),
                                const SizedBox(height: 8),
                                _buildNumberedStep(5, 'Add tomato sauce and simmer for 5 minutes.'),
                                const SizedBox(height: 8),
                                _buildNumberedStep(5, 'Mix with spaghetti squash and serve!'),
